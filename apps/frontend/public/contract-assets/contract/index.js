...
class _tuple_0 {
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0[0]).concat(_descriptor_1.toValue(value_0[1]).concat(_descriptor_1.toValue(value_0[2]).concat(_descriptor_2.toValue(value_0[3]))));
  }
}
...
class _tuple_2 {
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0[0]).concat(_descriptor_0.toValue(value_0[1]).concat(_descriptor_1.toValue(value_0[2])));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.credentialHolderSecret) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named credentialHolderSecret');
    }
    ...
    this.circuits = {
      registerCredential: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('registerCredential',
                                     ...
                                     'guardian-rail.compact line 40 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      proveAge: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const contextId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('proveAge',
                                     'argument 1 (as invoked from Typescript)',
                                     'guardian-rail.compact line 53 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(contextId_0.buffer instanceof ArrayBuffer && contextId_0.BYTES_PER_ELEMENT === 1 && contextId_0.length === 32)) {
          __compactRuntime.typeError('proveAge',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'guardian-rail.compact line 53 char 1',
                                     'Bytes<32>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(contextId_0),
            alignment: _descriptor_1.alignment()
          },
          output: undefined,
          publicTranscript: [],
        ...
        const result_0 = this._proveAge_0(context, partialProofData, contextId_0);
        partialProofData.output = { value: _descriptor_1.toValue(result_0), alignment: _descriptor_1.alignment() };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      },
      issuerKeyCommitmentFor(context, ...args_1) {
        return { result: pureCircuits.issuerKeyCommitmentFor(...args_1), context };
      },
      credentialCommitmentFor(context, ...args_1) {
        return { result: pureCircuits.credentialCommitmentFor(...args_1), context };
      },
    ...
    this.impureCircuits = {
      ...
      proveAge: this.circuits.proveAge
    };
  ...
  initialState(...args_0) {
    ...
    const _issuerKeyCommitment_0 = args_0[1];
    const _minimumBirthDate_0 = args_0[2];
    const _policyVersion_0 = args_0[3];
    ...
    if (!(_issuerKeyCommitment_0.buffer instanceof ArrayBuffer && _issuerKeyCommitment_0.BYTES_PER_ELEMENT === 1 && _issuerKeyCommitment_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'guardian-rail.compact line 27 char 1',
                                 'Bytes<32>',
                                 _issuerKeyCommitment_0)
    }
    if (!(typeof(_minimumBirthDate_0) === 'bigint' && _minimumBirthDate_0 >= 0n && _minimumBirthDate_0 <= 4294967295n)) {
      __compactRuntime.typeError('Contract state constructor',
    ...
    if (!(typeof(_policyVersion_0) === 'bigint' && _policyVersion_0 >= 0n && _policyVersion_0 <= 65535n)) {
      __compactRuntime.typeError('Contract state constructor',
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.assert(_policyVersion_0 > 0n,
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(0n),
                                                                                              alignment: _descriptor_11.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(_issuerKeyCommitment_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(1n),
                                                                                              alignment: _descriptor_11.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(_minimumBirthDate_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_11.toValue(2n),
                                                                                              alignment: _descriptor_11.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(_policyVersion_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _credentialBirthDate_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 4294967295n)) {
      __compactRuntime.typeError('credentialBirthDate',
                                 'return value',
                                 'guardian-rail.compact line 11 char 1',
                                 'Uint<0..4294967296>',
                                 result_0)
    }
  ...
  _credentialSalt_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('credentialSalt',
                                 'return value',
                                 'guardian-rail.compact line 12 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _credentialHolderSecret_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.credentialHolderSecret(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('credentialHolderSecret',
                                 'return value',
                                 'guardian-rail.compact line 13 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _issuerSecret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('issuerSecret',
                                 'return value',
                                 'guardian-rail.compact line 14 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
    partialProofData.privateTranscriptOutputs.push({
  ...
  _registerCredential_0(context, partialProofData, commitment_0) {
    __compactRuntime.assert(this._equal_0(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                          ...
                                          this._issuerKeyCommitmentFor_0(this._issuerSecret_0(context,
                                                                                              partialProofData))),
  ...
  _proveAge_0(context, partialProofData, contextId_0) {
    const credentialCommitment_0 = this._credentialCommitmentFor_0(this._credentialBirthDate_0(context,
                                                                                               partialProofData),
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_11.toValue(3n),
                                                                                                                  alignment: _descriptor_11.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(credentialCommitment_0),
                                                                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                                                                       'member',
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
    ...
    let t_0;
    __compactRuntime.assert((t_0 = this._credentialBirthDate_0(context,
                                                               partialProofData),
                             t_0
                             <=
                             _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: false,
                                                                                                   result: undefined } }]).value)),
                            'Age policy is not satisfied');
    const nullifier_0 = this._nullifierFor_0(contextId_0,
                                             this._credentialHolderSecret_0(context,
                                                                            partialProofData),
    ...
    __compactRuntime.assert(!_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'Proof already used for this context');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
  ...
  _issuerKeyCommitmentFor_0(secret_0) {
    return this._persistentHash_0([new Uint8Array([103, 117, 97, 114, 100, 105, 97, 110, 45, 114, 97, 105, 108, 58, 105, 115, 115, 117, 101, 114, 58, 118, 49, 0, 0, 0, 0, 0, 0, 0, 0, 0]),
                                   secret_0]);
  }
  _credentialCommitmentFor_0(birthDate_0, salt_0) {
    return this._persistentHash_1([new Uint8Array([103, 117, 97, 114, 100, 105, 97, 110, 45, 114, 97, 105, 108, 58, 99, 114, 101, 100, 101, 110, 116, 105, 97, 108, 58, 118, 49, 0, 0, 0, 0, 0]),
                                   birthDate_0,
                                   salt_0]);
  }
  _nullifierFor_0(contextId_0, holderSecret_0, version_0) {
    return this._persistentHash_2([new Uint8Array([103, 117, 97, 114, 100, 105, 97, 110, 45, 114, 97, 105, 108, 58, 110, 117, 108, 108, 105, 102, 105, 101, 114, 58, 118, 49, 0, 0, 0, 0, 0, 0]),
                                   contextId_0,
                                   holderSecret_0,
                                   version_0]);
  }
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'guardian-rail.compact line 24 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    spentNullifiers: {
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'guardian-rail.compact line 25 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
...
const _dummyContract = new Contract({
  ...
  credentialHolderSecret: (...args) => undefined,
  issuerSecret: (...args) => undefined
});
export const pureCircuits = {
  issuerKeyCommitmentFor: (...args_0) => {
    if (args_0.length !== 1) {
      throw new __compactRuntime.CompactError(`issuerKeyCommitmentFor: expected 1 argument (as invoked from Typescript), received ${args_0.length}`);
    }
    const secret_0 = args_0[0];
    if (!(secret_0.buffer instanceof ArrayBuffer && secret_0.BYTES_PER_ELEMENT === 1 && secret_0.length === 32)) {
      __compactRuntime.typeError('issuerKeyCommitmentFor',
                                 'argument 1',
                                 'guardian-rail.compact line 74 char 1',
                                 'Bytes<32>',
                                 secret_0)
    }
    return _dummyContract._issuerKeyCommitmentFor_0(secret_0);
  },
  credentialCommitmentFor: (...args_0) => {
    if (args_0.length !== 2) {
      throw new __compactRuntime.CompactError(`credentialCommitmentFor: expected 2 arguments (as invoked from Typescript), received ${args_0.length}`);
    }
    const birthDate_0 = args_0[0];
    const salt_0 = args_0[1];
    if (!(typeof(birthDate_0) === 'bigint' && birthDate_0 >= 0n && birthDate_0 <= 4294967295n)) {
      __compactRuntime.typeError('credentialCommitmentFor',
                                 'argument 1',
                                 'guardian-rail.compact line 81 char 1',
                                 'Uint<0..4294967296>',
                                 birthDate_0)
    }
    ...
    return _dummyContract._credentialCommitmentFor_0(birthDate_0, salt_0);
  },
  nullifierFor: (...args_0) => {
    if (args_0.length !== 3) {
      throw new __compactRuntime.CompactError(`nullifierFor: expected 3 arguments (as invoked from Typescript), received ${args_0.length}`);
    }
    const contextId_0 = args_0[0];
    const holderSecret_0 = args_0[1];
    const version_0 = args_0[2];
    if (!(contextId_0.buffer instanceof ArrayBuffer && contextId_0.BYTES_PER_ELEMENT === 1 && contextId_0.length === 32)) {
      __compactRuntime.typeError('nullifierFor',
                                 'argument 1',
                                 'guardian-rail.compact line 92 char 1',
                                 'Bytes<32>',
                                 contextId_0)
    }
    ...
    if (!(typeof(version_0) === 'bigint' && version_0 >= 0n && version_0 <= 65535n)) {
      __compactRuntime.typeError('nullifierFor',
                                 'argument 3',
                                 'guardian-rail.compact line 92 char 1',
                                 'Uint<0..65536>',
    ...
    return _dummyContract._nullifierFor_0(contextId_0, holderSecret_0, version_0);
  }
};
